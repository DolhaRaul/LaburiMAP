...
public class UserInterface
{
    ...
    private ServicePrietenii prietenii;
     ...
     */
    public UserInterface(ServiceUsers users, ServicePrietenii prietenii)
    {
        this.users = users;
...
//                command = myObj.next();
     ...
     */
    public void delete_prietenie() throws EntityIsNull, EntityNotFound {
